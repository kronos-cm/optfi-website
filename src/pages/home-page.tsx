      ...
      <section className="journal-block" id="journal">
        <div className="container">
          ...
          <div className="journal-cats">
            <span className="cat-chip active">All <span className="count">3</span></span>
          ...
          <div className="journal-grid">
            ...
            <article className="post post-side-a" onClick={() => window.location.href='/journal/defi-source-timestamp'} style={{cursor:'pointer'}}>
              <div className="post-thumb art-defi-source"><span className="badge">Source age</span></div>
              <div className="post-meta"><span className="cat">DeFi research</span><span>5 min</span><span>June 2026</span></div>
            ...
            <article className="post post-wide" onClick={() => window.location.href='/journal/strategy-proof'} style={{cursor:'pointer'}}>
